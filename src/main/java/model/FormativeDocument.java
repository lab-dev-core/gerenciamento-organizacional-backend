...
public class FormativeDocument {
    ...
    // Relacionamentos para controle de acesso

    // Para documentos específicos de etapa
    @ManyToMany
    @JoinTable(
            name = "document_allowed_stages",
            joinColumns = @JoinColumn(name = "document_id"),
            inverseJoinColumns = @JoinColumn(name = "life_stage")
    )
    private Set<User.LifeStage> allowedStages;

    // Para documentos específicos de local
    @ManyToMany
    @JoinTable(
    ...
    // Para documentos com acesso restrito a usuários específicos
    @ManyToMany
    @JoinTable(
